...
import src.domain.Categorias;
import src.domain.Evento;
...
public class BDs {
	public static void crearTablaUsuarios() {
		...
		try {
			...
			connection = DriverManager.getConnection("jdbc:sqlite:resources/DB/usuarioEventosYDemas");//a partir de los ultimo : es donde quieres que se guarden
...
//	}
	...
	public static String obtenerIconoPerfil(String username) {
		...
		try {
			Class.forName("org.sqlite.JDBC");
			Connection connection = DriverManager.getConnection("jdbc:sqlite:resources/DB/usuarioEventosYDemas");
...
//			statement.executeUpdate("drop table if exists person");
	...
	public static int contarHabitos(String usuario, String fechaHoy) {
	    ...
	    // Conexión a la base de datos
	    String url = "jdbc:sqlite:resources/DB/usuarioEventosYDemas";
