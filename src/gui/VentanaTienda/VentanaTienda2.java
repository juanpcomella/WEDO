...
public class VentanaTienda2 extends JFrame {
    ...
    public void insertarIconosBaseDeDatos(Usuario usuario) {
        ...
        Item[] iconos = {
                new Item("LogoHomer", 85, "foto", "/resources/imagenes/logoHomer.png"),
                new Item("LogoOso", 120, "foto", "/resources/imagenes/logoOso.png"),
                new Item("LogoPerro", 200, "foto", "/resources/imagenes/logoPerro.png"),
                new Item("LogoUnicornio", 70, "foto", "/resources/imagenes/logoUnicornio.png"),
                new Item("LogoPlayaPalmeras", 140, "foto", "/resources/imagenes/logoPlayaPalmeras.png"),
                new Item("PerfilMonje", 300, "foto", "/resources/imagenes/perfilMonje.png"),
                new Item("LogoPanda", 200, "foto", "/resources/imagenes/logoPanda.png")
        };
    ...
    public void insertarMonedasBaseDeDatos() {
        Item[] monedas = {
                new Item("ZorroEnLuna", 50, "moneda", "/resources/imagenes/zorroenluna.png"),
                new Item("PizzaAzul", 100, "moneda", "/resources/imagenes/pizzaazul.png"),
                new Item("FutCoin", 50, "moneda", "/resources/imagenes/futcoin.png"),
                new Item("FlorEnLuna", 100, "moneda", "/resources/imagenes/florenluna.png"),
                new Item("CrabCoin", 50, "moneda", "/resources/imagenes/crabcoin.png"),
                new Item("DragonCoin", 100, "moneda", "/resources/imagenes/dragoncoin.png"),
                new Item("GhostCoin", 50, "moneda", "/resources/imagenes/ghostcoin.png"),
                new Item("NubeCoin", 100, "moneda", "/resources/imagenes/nubecoin.png"),
                new Item("OnePiece", 50, "moneda", "/resources/imagenes/onepiece.png"),
                new Item("IndiaCoin", 100, "moneda", "/resources/imagenes/indiacoin.png")
        };
    ...
    private JPanel crearHeaderPanel(Usuario usuario) {
        ...
        JLabel dineroL = new JLabel(cargarImagen("/resources/imagenes/coin_sin_fondo.png", 30, 30));
    ...
    private void llenarTablaIconos(DefaultTableModel modeloIcono, Usuario usuario) {
        ...
        for (int i = 0; i < listaItems.size(); i++) {
            ...
            modeloIcono.addRow(new Object[]{
                    icono,
                    new Object[]{item.getPrecioItem(), cargarImagen("/resources/imagenes/coin_sin_fondo.png", 30, 30)} // Precio y moneda
            });
        }
    }
