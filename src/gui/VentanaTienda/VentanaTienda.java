...
import src.db.BDs;
import src.gui.MainWindow.MainWindow;
import src.gui.MainWindow.Navbar;
...
public class VentanaTienda extends JFrame {
    ...
    public VentanaTienda(Usuario usuario) {
     ...
     // Crear el JTable
        ...
        ImageIcon icon1 = new ImageIcon("resources/imagenes/Imagen1.png");
        Image img = icon1.getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH);
        icon1 = new ImageIcon(img);

        ImageIcon logoOso = cargarImagen("resources/imagenes/logoOso.png", 80, 80);
        ImageIcon logoPerro = cargarImagen("resources/imagenes/logoPerro.png", 80, 80);
        ImageIcon logoPanda = cargarImagen("resources/imagenes/logoPanda.png", 80, 80);
        ImageIcon logoUnicornio = cargarImagen("resources/imagenes/logoUnicornio.png", 80, 80);
        ImageIcon perfilMonje = cargarImagen("resources/imagenes/perfilMonje.png", 80, 80);
        ImageIcon logoPlayaPalmeras = cargarImagen("resources/imagenes/logoPlayaPalmeras.png", 80, 80);
        ImageIcon logoHomer = cargarImagen("resources/imagenes/logoHomer.png", 80, 80);

        ImageIcon icon2 = cargarImagen("resources/imagenes/coin_sin_fondo.png", 50, 50);
...
//                    money = Integer.parseInt(dinero);
        ...
        ImageIcon zorroenluna = cargarImagen("resources/imagenes/zorroenluna.png", 80, 80);
        ImageIcon pizzaazul = cargarImagen("resources/imagenes/pizzaazul.png", 80, 80);
        ...
        ImageIcon futCoin = cargarImagen("resources/imagenes/futcoin.png", 80, 80);
        ImageIcon florenluna = cargarImagen("resources/imagenes/florenluna.png", 80, 80);

        modeloDinero.addRow(new Object[]{futCoin, new Object[]{50, icon2}});
        modeloDinero.addRow(new Object[]{florenluna, new Object[]{100, icon2}});

        ImageIcon crabcoin = cargarImagen("resources/imagenes/crabcoin.png", 80, 80);
        ImageIcon dragoncoin = cargarImagen("resources/imagenes/dragoncoin.png", 80, 80);
        ...
        ImageIcon ghostCoin = cargarImagen("resources/imagenes/ghostcoin.png", 80, 80);
        ImageIcon nubeCoin = cargarImagen("resources/imagenes/nubecoin.png", 80, 80);

        modeloDinero.addRow(new Object[]{ghostCoin, new Object[]{50, icon2}});
        modeloDinero.addRow(new Object[]{nubeCoin, new Object[]{100, icon2}});

        ImageIcon onepiece = cargarImagen("resources/imagenes/onepiece.png", 80, 80);
        ImageIcon indiacoin = cargarImagen("resources/imagenes/indiacoin.png", 80, 80);
