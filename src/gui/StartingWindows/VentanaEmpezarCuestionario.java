...
public class VentanaEmpezarCuestionario extends JFrame {
	...
	public VentanaEmpezarCuestionario(Usuario usuario) {
        setTitle("WEDO");
        setSize(700, 500);
        ...
        JLabel bienvenidoL = new JLabel(" Bienvenido "+usuario.getNombreUsuario()+"!");
...
//        panelGeneral.add(panelDch, BorderLayout.EAST);
        ...
        //estos dos paneles son por si queremos poner abajo unas pequeñas resources.imagenes de presentacion de la app y que el
